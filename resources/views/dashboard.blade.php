...
<html lang="en">
    ...
    <head>
      ...
      <title>HOME | Profesional Academy of the Philippines</title>
      ...
      <link href="../../../landing-page/assets/vendor/animate.css/animate.min.css" rel="stylesheet">
          ...
          <nav id="navmenu" class="navmenu">
            <ul>
              ...
              <li> <a>
                ...
                @csrf
                  <button class="buttonsubmit" type="submit">Logout</button>
                </form></a>
              </li>
            </ul>
          ...
          <div id="hero-carousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-item active slide-bg-1">
              <div class="carousel-container">
                <h2 class="animate__animated animate__fadeInDown">Profesional Academy of the Philippines

                  @auth
                      <p> <h1>Hello, {{ $user->name }}! </h1></p>
                  @endauth
            ...
            <!-- Slide 2 -->
            <div class="carousel-item slide-bg-1">
              <div class="carousel-container">
              ...
              <div class="tab-pane fade active show" id="features-tab-1">
                <div class="row">
                  ...
                  <div class="col-lg-6 order-1 order-lg-2 text-center">
                    <img src="../../../landing-page/assets/img/working-1.jpg" alt="" class="img-fluid">
                  </div>
                </div>
          ...
          <div class="container">
            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="team-member">
                  <div class="member-img">
                    <img src="../../../landing-page/assets/img/team/team-1.jpg" class="img-fluid" alt="">
                    <div class="social">
                  ...
                  <div class="member-info">
                    <h4>Arm&hearts;sWhel Villarmia</h4>
              ...
              <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                <div class="team-member">
                  <div class="member-img">
                    <img src="../../../landing-page/assets/img/team/team-2.jpg" class="img-fluid" alt="">
                    <div class="social">
                      <a href=""><i class="bi bi-twitter-x"></i></a>
                      <a href=""><i class="bi bi-facebook"></i></a>
                      <a href=""><i class="bi bi-instagram"></i></a>
              ...
              <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                <div class="team-member">
                  <div class="member-img">
                    <img src="../../../landing-page/assets/img/team/team-3.jpg" class="img-fluid" alt="">
                    <div class="social">
                      <a href=""><i class="bi bi-twitter-x"></i></a>
                      <a href=""><i class="bi bi-facebook"></i></a>
                      <a href=""><i class="bi bi-instagram"></i></a>
              ...
              <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="400">
                <div class="team-member">
                  <div class="member-img">
                    <img src="../../../landing-page/assets/img/team/team-4.jpg" class="img-fluid" alt="">
                    <div class="social">
                      <a href=""><i class="bi bi-twitter-x"></i></a>
                      <a href=""><i class="bi bi-facebook"></i></a>
                      <a href=""><i class="bi bi-instagram"></i></a>
            ...
            <div class="row gy-4">
              ...
              <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <article>
                  ...
                  <div class="post-img">
                    <img src="../../../landing-page/assets/img/blog/blog-1.jpg" alt="" class="img-fluid">
                  </div>
                  ...
                  <div class="d-flex align-items-center">
                    <img src="../../../landing-page/assets/img/blog/blog-author.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                    <div class="post-meta">
              ...
              <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <article>
                  ...
                  <div class="post-img">
                    <img src="../../../landing-page/assets/img/blog/blog-2.jpg" alt="" class="img-fluid">
                  </div>
                  ...
                  <div class="d-flex align-items-center">
                    <img src="../../../landing-page/assets/img/blog/blog-author-2.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                    <div class="post-meta">
              ...
              <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <article>
                  ...
                  <div class="post-img">
                    <img src="../../../landing-page/assets/img/blog/blog-3.jpg" alt="" class="img-fluid">
                  </div>
                  ...
                  <div class="d-flex align-items-center">
                    <img src="../../../landing-page/assets/img/blog/blog-author-3.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                    <div class="post-meta">
